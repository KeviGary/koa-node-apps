...
global.loadSysLibEx = function(lib, alias) { global[alias] = require(lib); };
...
global.loadAppLibEx = function(lib, alias) { global[alias] = appRequire(global.AppPath + lib); };
...
global.loadCoreLibEx = function(lib, alias) { global[alias] = appRequire(global.LibPath + 'core/' + lib); };
...
global.loadModelEx = function(lib, alias) { global[alias] = appRequire(global.AppPath + 'model/' + lib); };
